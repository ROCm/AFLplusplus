...
#define SHM_FUZZ_ENV_VAR "__AFL_SHM_FUZZ_ID"
  ...
  /* Match-table-cov extensions: pass the variable-size fuzz map size to the
     target via this env var, with a sensible default sized off MAX_FILE. */
